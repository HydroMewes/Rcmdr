...
dialogAnpassung <- function()
{
  ...
  radio.but.achsenskal <- gradio(achsenskal, container = frm.achsenskal)
  addHandlerClicked(radio.but.achsenskal, handler=function(h,..) {
  ...
  btnAuswet <- gbutton("Auswertung", container = frm.auswertung,
                     ...
                     {
                       print("befor fitIt")
                       .GlobalEnv$at.least.one.vert <- svalue(.GlobalEnv$check.AEV.MM) ||
